...
<div class="form-group row">
  ...
  <div class="col-3">
    <input required type="number" class="form-control"  v-model="newTree.longitude" id="example-text-input" placeholder="longitude">
  </div>
<div class="invalid-feedback">
...
<div class="form-group row">
  ...
  <div class="col-3">
    <input type="number" required class="form-control"  v-model="newTree.latitude" id="example-text-input" placeholder="latitude">
  </div>
<div class="invalid-feedback">
